...
public static void main(String[] args) {
		...
		for(int A = 0; A < nbEssai; A++) {
			motASaisir = Saisie.lire_String("Veuillez saisir votre essai avec la même taille que le mot a deviné. Si vous voulez abandonné, tapez SOL. Il vous reste " + (nbEssai-A) + " essais. : ");
			...
			else 
			{
				while(taille != motASaisir.length()) {
					motASaisir = Saisie.lire_String("Erreur de saisie. Veuillez resaisir votre essai avec la même taille que le mot a deviné. Si vous voulez abandonné, tapez SOL. Il vous reste " + (nbEssai-A) + " essais. : ");
				}
